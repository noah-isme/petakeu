...
<USER_REQUEST>
You are teamwork_preview_challenger (Challenger 1) for the Petakeu E2E Test Suite.
Your working directory is: /home/noah/project/petakeu/.agents/teamwork_preview_challenger_e2e_1
...
Responsibilities:
1. Adversarially analyze test assertions, coverage gaps, potential test flakiness, or unhandled edge cases in the E2E Playwright test suite.
2. Verify test discovery and execution integrity.
3. Issue a clear verdict: APPROVE or REQUEST_CHANGES.

Write your handoff report to `/home/noah/project/petakeu/.agents/teamwork_preview_challenger_e2e_1/handoff.md` and report back via send_message.
</USER_REQUEST>
