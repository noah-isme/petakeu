# Graph Report - petakeu  (2026-08-16)

## Corpus Check
- 568 files · ~525,820 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4778 nodes · 6264 edges · 537 communities (348 shown, 189 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 106 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `47444dfb`
...
- alert-service.ts
- m1_stress_and_controller.test.ts
...
- Progress Tracker — teamwork_preview_explorer_survey_3
...
- teamwork_preview_explorer_survey_2/progress.md
...
- `rejectLockedReportPeriod` --calls--> `assertFiscalPeriodUnlocked()`  [EXTRACTED]
  apps/server/src/routes/v1/reports.ts → apps/server/src/services/approval-service.ts
- `rejectLockedUploadPeriod` --calls--> `assertFiscalPeriodUnlocked()`  [EXTRACTED]
  apps/server/src/routes/v1/uploads.ts → apps/server/src/services/approval-service.ts
...
## Communities (537 total, 189 thin omitted)
...
Cohesion: 0.06
Nodes (50): rankings, renderPdf(), rows, addMonths(), applyHeaderStyle(), decodeSafeLogo(), DEFAULT_REPORT_BRANDING, fetchReportData() (+42 more)
...
### Community 3 - "cn"
Cohesion: 0.09
Nodes (32): AnalyticsSectionProps, MapModeToggle(), MapModeToggleProps, getIcon(), LeftSidebar(), LeftSidebarProps, SidebarItem, AnimatedCard (+24 more)
...
Cohesion: 0.15
Nodes (13): devDependencies, eslint-config-prettier, eslint-plugin-import, @types/jsonwebtoken, @types/node, @types/swagger-jsdoc, @typescript-eslint/parser, eslint-config-prettier (+5 more)
...
Cohesion: 0.13
Nodes (20): enqueueReport, actorId(), bodyObject(), cancelUpload, confirmUpload, createRegionAlias, deleteRegionAlias, getTemplate (+12 more)
...
Cohesion: 0.19
Nodes (15): getMigrationFiles(), MIGRATIONS_DIR, runMigrations(), shutdownPg(), shutdownRedis(), env, main(), startReportWorker() (+7 more)
...
Cohesion: 0.17
Nodes (14): defaultEmailQueue(), defaultEmailWorker(), defaultGenerationQueue(), defaultQueueEvents(), processScheduledReportEmail(), redisConnection(), registerScheduledReportSchedules(), ReportEmailWorkerLike (+6 more)
...
### Community 22 - "web/src/types/analytics.ts"
Cohesion: 0.14
...
Cohesion: 0.08
Nodes (45): getPgPool(), instrumentQuery(), getCached(), invalidateCacheByPrefix(), startMvRefreshCron(), MockPgPool, MockQuery, QueryCall (+37 more)
...
Cohesion: 0.06
Nodes (64): UploadDetailsResponse, ACCEPTED_MIME_TYPES, aliasRow(), cancelUpload(), createRegionAlias(), currentRow(), dbPeriod(), deactivateRegionAlias() (+56 more)
...
Cohesion: 0.13
Nodes (31): options, setupSwagger(), swaggerSpec, getRedisClient(), getReportQueue(), getUploadQueue(), registerRoutes(), createApp() (+23 more)
...
Cohesion: 0.15
Nodes (20): emailConfig, CalendarParts, defaultDatabase(), defaultQueue(), enqueueScheduledReport(), getCalendarParts(), getIsoWeek(), getScheduledReport() (+12 more)
...
Cohesion: 0.29
Nodes (6): 1. Observation, 2. Logic Chain, 3. Caveats, 4. Conclusion, 5. Verification Method, Handoff Report: Technical Survey for Extended Report Generation (Roadmap Item 2)
...
### Community 45 - "AnalyticsPage.tsx"
Cohesion: 0.12
Nodes (21): formatUpdatedAt(), hasAnalyticsData(), normalizeAnalyticsPeriod(), AnalyticsEmptyState(), AnalyticsErrorState(), AnalyticsLoadingState(), AnalyticsStateProps, PublicAnalyticsNotice() (+13 more)
...
Cohesion: 0.22
Nodes (9): dependencies, exceljs, redis, swagger-jsdoc, swagger-ui-express, exceljs, redis, swagger-jsdoc (+1 more)
...
### Community 55 - "AdminDashboard.tsx"
Cohesion: 0.23
...
Cohesion: 0.14
Nodes (33): Role, appendTransition(), ApprovalRow, approvalService, approveWorkflow(), assertFiscalPeriodUnlocked(), assertPeriodUnlockedWithClient(), assertWorkflowPeriodUnlocked() (+25 more)
...
Cohesion: 0.12
Nodes (16): buildLegend(), getQuantile(), InfoCard(), InfoCardProps, LegendCard(), LegendCardProps, LegendItem, formatCurrency() (+8 more)
...
Cohesion: 0.08
Nodes (25): Branch Protection Rules, Branch Strategy, CI/CD Metrics to Track, CI/CD Pipeline Documentation, CI Pipeline (GitHub Actions), Common CI Failures, Debugging Failed Runs, Environment Configurations (+17 more)

### Community 105 - "Entity Definitions"
Cohesion: 0.18
...
Cohesion: 0.12
Nodes (35): ensureBucket(), getPresignedDownloadUrl(), getS3Client(), uploadStreamToS3(), uploadToS3(), EnqueueReportResponse, ReportDetailsResponse, EnqueueUploadResponse (+27 more)
...
Cohesion: 0.08
Nodes (26): 1. Static Analysis (Continuous), 2. Unit Tests (Vitest), 3. Integration Tests (Vitest + Testcontainers), 4. End-to-End Tests (Playwright), 5. Performance Tests (k6), Adding New Tests, CI/CD Integration, Common Issues (+18 more)

### Community 112 - "Table Definitions"
Cohesion: 0.08
Nodes (25): 1. `regions` - Administrative Boundaries, 2. `payments` - Payment Records, 3. `uploads` - File Upload Tracking, 3a. `region_aliases` - Canonical Import Aliases, 4. `report_jobs` - Report Generation Jobs, 5. `audit_logs` - Immutable Request Audit Trail, 6. `revenue_targets` - Monthly Analytics Targets, 7. `approval_workflows` and `approval_workflow_events` (+17 more)
...
Cohesion: 0.10
Nodes (21): 10.1 Key UI Utility Helper (`cn` Pattern), 10.2 Recommended Component Directory Structure, 10. Implementation Guide for Developers, 1. Design Philosophy & Principles, 2.1 Primary & Accent Colors, 2.2 Canvas & Surfaces, 2.3 Semantic Colors, 2.4 Neutral Palette (+13 more)
...
Cohesion: 0.11
Nodes (19): 10. Phase 4 — Advanced GovTech & Analytics, 1. Project Status Summary, 2. Phase 1 — MVP (Current Phase), 3. Phase 2 — Analytics & Insights, 4.1 — High-Fidelity Visual Reporting & Template Engine, 4.2 — Enterprise SSO & Region Delegation, 4.3 — Power-User Navigation & UX Polish, 4.4 — Dynamic Tax & Fiscal Rules Engine (+11 more)
...
Cohesion: 0.09
Nodes (22): Appendix: Production Checklist, Architecture Overview, Automated Backups, Backup & Disaster Recovery, Common Issues, Debug Commands, Docker Compose, Inisialisasi Data (Seeding) (+14 more)
...
### Community 164 - "asObject"
Cohesion: 0.40
Nodes (11): asNumber(), asObject(), asString(), firstValue(), normalizeFinding(), normalizeReportingDetail(), normalizeSeverity(), normalizeStagedRow() (+3 more)
...
### Community 171 - "BRIEFING — 2026-08-11T01:46:00Z"
Cohesion: 0.20
...
### Community 174 - "8. Enable and verify staged confirmation"
Cohesion: 0.40
...
Cohesion: 0.17
Nodes (11): ScheduledReportRuntimeDependencies, createReportEmailDispatcher(), createTransport(), escapeHtml(), ReportEmailDispatcher, ReportEmailDispatcherDependencies, ReportEmailLogger, ReportEmailTransport (+3 more)

### Community 177 - "region-controller.ts"
Cohesion: 0.33
Nodes (5): getRegionSummary, listRegions, regionController, regionRouter, regionService
...
### Community 187 - "11. Phase 5 — Platform Scale & Operational Maturity"
Cohesion: 0.40
Nodes (5): 11. Phase 5 — Platform Scale & Operational Maturity, 5.1 — Vector Tiles & Spatial Optimization, 5.2 — Standalone Worker Container Scaling, 5.3 — Centralized Observability & Incident Response, 5.4 — Advanced Test Automation

### Community 193 - "4. Component Library"
Cohesion: 0.18
Nodes (11): 4.1 StatCard Component, 4.2 AnimatedCard Component, 4.3 Tabs Component, 4.4 Sidebar Navigation, 4.5 Topbar Component, 4. Component Library, Sidebar Features, Styling & Accessibility (+3 more)
...
### Community 203 - "5. Key Screens Specification"
Cohesion: 0.18
Nodes (11): 5.1 Dashboard Screen (`MapPage.tsx`), 5.2 Upload Page (`UploadPage.tsx`), 5.3 Reports Page (`ReportsPage.tsx`), 5.4 Ranking Screen (`RankFinLeaderboard`), 5.5 Reporting Matrix Screen, 5.6 Missing Data View, 5. Key Screens Specification, Interactivity (+3 more)
...
### Community 207 - "ScheduledReportJobData"
Cohesion: 0.50
Nodes (3): ReportGenerationLookupQueue, ScheduledReportQueue, ScheduledReportJobData
...
### Community 209 - "BRIEFING — 2026-08-10T18:45:00Z"
Cohesion: 0.18
...
Cohesion: 0.18
Nodes (10): Artifact Index, Attack Surface, BRIEFING — 2026-08-11T01:44:15Z, Current Parent, 🔒 Key Constraints, Key Decisions Made, Mission, 🔒 My Identity (+2 more)

### Community 213 - "BRIEFING — 2026-08-11T01:44:16+07:00"
Cohesion: 0.18
Nodes (10): Artifact Index, Attack Surface, BRIEFING — 2026-08-11T01:44:16+07:00, Current Parent, 🔒 Key Constraints, Key Decisions Made, Mission, 🔒 My Identity (+2 more)

### Community 214 - "Review & Handoff Report — Milestone M1: Redis Caching Architecture"
Cohesion: 0.17
Nodes (11): 1. Executive Summary, 2. Observation, 3. Logic Chain, 4. Quality & Adversarial Review Findings, 5. Stress Test Results & Edge Case Matrix, 6. Caveats, 7. Conclusion, 8. Verification Method (+3 more)
...
Cohesion: 0.29
Nodes (5): enqueueEmailForCompletedReport(), ScheduledReportEmailQueue, getScheduledReportEmailJobId(), ScheduledReportQueueOptions, ScheduledReportEmailJobData
...
### Community 222 - "m1_stress_and_controller.test.ts"
Cohesion: 0.31
Nodes (6): mockRedisGet, mockRedisSetEx, geoController, getChoropleth, geoRouter, geoService
...
### Community 228 - "BRIEFING — 2026-08-11T01:00:30Z"
Cohesion: 0.18
Nodes (10): Artifact Index, Attack Surface, BRIEFING — 2026-08-11T01:00:30Z, Current Parent, 🔒 Key Constraints, Key Decisions Made, Loaded Skills, Mission (+2 more)
...
### Community 231 - "BRIEFING — 2026-08-11T01:00:00+07:00"
Cohesion: 0.18
Nodes (10): Artifact Index, Attack Surface, BRIEFING — 2026-08-11T01:00:00+07:00, Current Parent, 🔒 Key Constraints, Key Decisions Made, Mission, 🔒 My Identity (+2 more)
...
### Community 234 - "BRIEFING — 2026-08-11T01:02:05Z"
Cohesion: 0.20
...
Cohesion: 0.18
Nodes (10): Artifact Index, Attack Surface, BRIEFING — 2026-08-11T01:02:00Z, Current Parent, 🔒 Key Constraints, Key Decisions Made, Loaded Skills, Mission (+2 more)
...
### Community 241 - "BRIEFING — 2026-08-11T01:15:32Z"
Cohesion: 0.22
Nodes (8): Artifact Index, BRIEFING — 2026-08-11T01:15:32Z, Current Parent, Investigation State, 🔒 Key Constraints, Key Decisions Made, Mission, 🔒 My Identity

### Community 242 - "BRIEFING — 2026-08-10T18:17:00Z"
Cohesion: 0.22
Nodes (8): Artifact Index, BRIEFING — 2026-08-10T18:17:00Z, Current Parent, Investigation State, 🔒 Key Constraints, Key Decisions Made, Mission, 🔒 My Identity

### Community 243 - "BRIEFING — 2026-08-11T01:13:16Z"
Cohesion: 0.22
Nodes (8): Artifact Index, BRIEFING — 2026-08-11T01:13:16Z, Current Parent, Investigation State, 🔒 Key Constraints, Key Decisions Made, Mission, 🔒 My Identity
...
### Community 245 - "BRIEFING — 2026-08-11T01:02:30Z"
Cohesion: 0.20
Nodes (9): Artifact Index, BRIEFING — 2026-08-11T01:02:30Z, Current Parent, 🔒 Key Constraints, Key Decisions Made, Mission, 🔒 My Identity, Review Checklist (+1 more)
...
### Community 253 - "Dispatch — Forensic Auditor (Milestone M2)"
Cohesion: 0.33
Nodes (5): 2026-08-11T00:57:12Z, Dispatch — Forensic Auditor (Milestone M2), Files to Audit, Forensic Verification Protocol, Objective
...
### Community 255 - "Dispatch — Reviewer 1 (Milestone M2)"
Cohesion: 0.33
Nodes (5): 2026-08-11T00:57:05Z, Code to Review, Dispatch — Reviewer 1 (Milestone M2), Objective, Verification Scope

### Community 256 - "Dispatch — Reviewer 2 (Milestone M2)"
Cohesion: 0.33
Nodes (5): 2026-08-11T00:57:06Z, Code to Audit, Dispatch — Reviewer 2 (Milestone M2), Objective, Verification Scope
...
### Community 260 - "Dispatch — Challenger 1 (Milestone M2)"
Cohesion: 0.40
Nodes (4): 2026-08-11T00:57:09Z, Dispatch — Challenger 1 (Milestone M2), Objective, Verification Requirements

### Community 261 - "Dispatch — Challenger 2 (Milestone M2)"
Cohesion: 0.40
Nodes (4): 2026-08-11T00:57:10Z, Dispatch — Challenger 2 (Milestone M2), Objective, Verification Requirements
...
### Community 265 - "Progress Log — teamwork_preview_challenger_m2_1"
Cohesion: 0.50
Nodes (3): Current Task, Milestones & Status, Progress Log — teamwork_preview_challenger_m2_1
...
### Community 280 - "Progress Tracker — teamwork_preview_explorer_survey_3"
Cohesion: 0.50
Nodes (3): Current Status, Progress Tracker — teamwork_preview_explorer_survey_3, Tasks

### Community 288 - "Empirical Challenge & Verification Handoff Report — Milestone M1"
Cohesion: 0.22
Nodes (8): 1. Observation, 2. Logic Chain, 3. Caveats, 4. Conclusion & Evaluation Report, 5. Verification Method, Challenge Summary, Empirical Challenge & Verification Handoff Report — Milestone M1, Stress Test Results Summary
...
### Community 291 - "Forensic Audit Report — Milestone M2 (`GET /healthz`)"
Cohesion: 0.20
...
Cohesion: 0.22
Nodes (8): 1. Observation, 2. Logic Chain, 3. Caveats, 4. Conclusion, 5. Verification Method, Codebase Inspection, Empirical Test Execution, Handoff Report — Milestone M2 Empirical Verification (`GET /healthz`)

### Community 294 - "Handoff Report — Milestone M2 (Health Check Review)"
Cohesion: 0.25
...
Cohesion: 0.29
Nodes (6): 1. Observation, 2. Logic Chain, 3. Caveats, 4. Conclusion, 5. Verification Method, Handoff Report — Empirical Challenger (Milestone M2)
...
### Community 299 - "Forensic Audit Report — Milestone M1: Redis Caching & Invalidation"
Cohesion: 0.25
Nodes (7): 1. Observation, 2. Logic Chain, 3. Caveats, 4. Conclusion, 5. Verification Method, Forensic Audit Report — Milestone M1: Redis Caching & Invalidation, Phase Results
...
### Community 323 - "Handoff Report — Code Review & Verification: Milestone M1 (Redis Caching & Invalidation)"
Cohesion: 0.29
Nodes (6): 1. Observation, 2. Logic Chain, 3. Caveats, 4. Conclusion, 5. Verification Method, Handoff Report — Code Review & Verification: Milestone M1 (Redis Caching & Invalidation)
...
Cohesion: 0.08
Nodes (39): mockQuery, mockRedisConnect, mockRedisDel, mockRedisGet, mockRedisKeys, mockRedisOn, mockRedisSetEx, EnvConfig (+31 more)
...
Cohesion: 0.14
Nodes (20): ApiHttpError, createApiHttpError(), errorMessage(), ErrorPayload, fetchJson(), JsonObject, responseError(), RegionAlias (+12 more)
...
### Community 474 - "analytics-utils.ts"
Cohesion: 0.13
Nodes (26): formatAmount(), formatNumber(), formatPercent(), formatPeriod(), idrFormatter, numberFormatter, percentWidth(), AnalyticsSection() (+18 more)
...
Cohesion: 0.25
Nodes (13): allowRoles, assertUserRole(), AuthPayload, Express, hasMinimumRole(), isRole(), Request, requireAllowList() (+5 more)
...
Cohesion: 0.36
Nodes (13): actorFromRequest(), approve, firstString(), get, lockPeriod, publish, requestBody(), review (+5 more)
...
Cohesion: 0.08
Nodes (31): analyticsController, approvalController, auditController, listAuditLogs, reportController, uploadController, isAuthPayload(), requireAnyRole() (+23 more)
...
### Community 500 - "Common Queries"
Cohesion: 0.40
Nodes (5): Choropleth Data (using Materialized View), Common Queries, Get Regions with Parent Names, Monthly Payment Summary by Region, Region Detail with Trends
...
### Community 506 - "10. Rollback and restore evidence"
Cohesion: 0.40
...
### Community 510 - "logger.ts"
Cohesion: 0.10
Nodes (24): getReportById, listReports, boundedString(), deriveContext(), Express, firstString(), getRequestField(), getRequestId() (+16 more)

### Community 512 - "9. Data Visualization Standards"
Cohesion: 0.50
Nodes (4): 9.1 Semantic Chart Colors, 9.2 Map Choropleth Color Gradient, 9.3 Visual Differentiation: Zero vs. Missing Data, 9. Data Visualization Standards
...
### Community 515 - "Prerequisites"
Cohesion: 0.67
Nodes (3): External Dependencies, Infrastructure Requirements, Prerequisites

### Community 518 - "CD Pipeline (Deployment)"
Cohesion: 0.67
Nodes (3): CD Pipeline (Deployment), Production Deployment (Manual), Staging Release Verification (Manual, protected)

### Community 522 - "Rollback Procedures"
Cohesion: 0.67
Nodes (3): Production Rollback, Quick Rollback (Staging), Rollback Procedures
...
## Knowledge Gaps
- **2655 isolated node(s):** `mockQuery`, `mockRedisGet`, `mockRedisSetEx`, `mockRedisKeys`, `mockRedisDel` (+2650 more)
...
- **Why does `vitest` connect `vitest` to `server.ts`, `report-worker.ts`, `scheduled-report-service.ts`, `routes.ts`, `compilerOptions`, `upload-pipeline.integration.test.ts`, `middleware/auth.ts`, `redis.ts`, `report-email-service.ts`, `validators/analytics.ts`, `Legend.tsx`, `client.ts`, `UploadPage.tsx`, `AuditLogInspector.tsx`, `getPgPool`, `analytics-utils.ts`, `upload-service.ts`, `m1_stress_and_controller.test.ts`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `getPgPool()` connect `getPgPool` to `server.ts`, `report-worker.ts`, `approval-service.ts`, `scheduled-report-service.ts`, `buildRankingQuery`, `upload-pipeline.integration.test.ts`, `upload-controller.ts`, `src/index.ts`, `redis.ts`, `upload-service.ts`, `analytics-service.ts`, `buildOverview`, `alert-service.ts`, `logger.ts`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `react` connect `cn` to `web/.eslintrc.json`, `Topbar.tsx`, `CommandPalette.tsx`, `MapDashboard.tsx`, `ReportBuilderPage.tsx`, `AnalyticsPage.tsx`, `lib/auth.ts`, `App.tsx`, `Legend.tsx`, `MapPage.tsx`, `AdminDashboard.tsx`, `AuditLogInspector.tsx`, `main.tsx`, `ReportsPage.tsx`, `UploadPage.tsx`?**
