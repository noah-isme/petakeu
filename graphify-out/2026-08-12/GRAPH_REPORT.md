# Graph Report - petakeu  (2026-08-12)

## Corpus Check
- 557 files · ~515,642 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4695 nodes · 6127 edges · 532 communities (345 shown, 187 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 105 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `28f96d0c`
...
- `rankfin_scores` --references--> `regions`  [EXTRACTED]
  apps/server/migrations/003_gamification.sql → apps/server/migrations/001_init.sql
- `region_aliases` --references--> `regions`  [EXTRACTED]
  apps/server/migrations/007_staged_ingestion.sql → apps/server/migrations/001_init.sql
...
Cohesion: 0.05
Nodes (48): rankings, renderPdf(), rows, addMonths(), applyHeaderStyle(), decodeSafeLogo(), DEFAULT_REPORT_BRANDING, fetchReportData() (+40 more)
...
Cohesion: 0.15
Nodes (13): devDependencies, eslint, eslint-config-prettier, eslint-plugin-import, @types/jsonwebtoken, @types/swagger-jsdoc, @typescript-eslint/parser, eslint (+5 more)
...
Cohesion: 0.11
Nodes (12): buildSummary(), nowIso(), periodToDate(), ReportJobItem, reportsStore, StagedMockRow, stagedRowsStore, updateReportStatuses() (+4 more)

### Community 13 - "upload-controller.ts"
Cohesion: 0.12
Nodes (22): enqueueReport, getReportById, listReports, reportController, actorId(), bodyObject(), cancelUpload, confirmUpload (+14 more)
...
Cohesion: 0.14
Nodes (18): EnvConfig, getMigrationFiles(), MIGRATIONS_DIR, runMigrations(), shutdownPg(), shutdownRedis(), env, main() (+10 more)
...
Cohesion: 0.11
Nodes (16): MAP_PALETTE, PERIOD_DATA, PERIOD_OPTIONS, Sidebar(), SidebarItem, SidebarProps, TOAST_CONFIG, ToastContainer() (+8 more)
...
Cohesion: 0.11
Nodes (31): instrumentQuery(), invalidateCacheByPrefix(), startMvRefreshCron(), EXPECTED_HEADERS, findingToError(), isFuturePeriod(), normalizeHeader(), parseRows() (+23 more)
...
Cohesion: 0.08
Nodes (46): getPgPool(), UploadDetailsResponse, getLeague(), enqueueReport(), getReport(), listReports(), reportService, rowToJob() (+38 more)
...
Cohesion: 0.09
Nodes (45): options, setupSwagger(), swaggerSpec, getRedisClient(), getReportQueue(), getUploadQueue(), boundedString(), deriveContext() (+37 more)
...
### Community 53 - "audit-service.ts"
Cohesion: 0.22
Nodes (8): auditController, listAuditLogs, auditRouter, AuditEntryInput, AuditLogItem, AuditLogQueryParams, auditService, getAuditLogs()
...
Cohesion: 0.15
Nodes (30): Role, appendTransition(), ApprovalRow, approvalService, approveWorkflow(), assertPeriodUnlockedWithClient(), assertWorkflowPeriodUnlocked(), fromDatabasePeriod() (+22 more)
...
Cohesion: 0.12
Nodes (17): 1. Fiscal Analysts (BPKAD / Kemendagri), 1. Overview, 2. Problem Statement, 2. Provincial Government Operators, 3. Target Users, 4. Goals & Success Metrics, 6.1 Performance Requirements, 6.2 Security & Authentication (+9 more)

### Community 102 - "MSW to Backend Migration Guide"
Cohesion: 0.11
Nodes (18): 1.1 Provision Production Database, 1.2 Run Migrations, 1.3 Provision Redis, 1.4 Provision Object Storage, 1.5 Configure Infrastructure Secrets, Backend Implementation (Phase 2 Complete), Frontend Switchover (Phase 3 Complete), Migration Checklist (+10 more)
...
### Community 105 - "5. Functional Requirements"
Cohesion: 0.13
Nodes (15): 5.1 Data Import Module, 5.2 Region Master Module, 5.3 Dashboard & Visualization Module, 5.4 Ranking Engine Module, 5.5 Missing Data Analysis Module, 5.6 Reporting Matrix Module, 5.7 Export Engine, 5. Functional Requirements (+7 more)
...
Cohesion: 0.07
Nodes (27): 10. Authentication & Authorization, 11. Deployment, 12. Key Data Flows, 1. System Overview, 2. Architecture Diagram, 3. Frontend Architecture, 4. Backend Architecture, 5. Database Layer (+19 more)
...
Cohesion: 0.11
Nodes (19): Applied Migrations, Backup & Recovery, Choropleth Data (using Materialized View), Common Queries, Data Dictionary, Database Schema Documentation, Entity Relationship Diagram, Future Migrations (+11 more)
...
### Community 147 - "math.ts"
Cohesion: 0.67
Nodes (3): buildQuantileLegend(), classifyQuantile(), quantile()

### Community 148 - "routes.ts"
Cohesion: 0.26
Nodes (10): RouteGate(), RouteGateProps, APP_ROUTES, AppRouteDefinition, AppRouteKey, canAccessRoute(), getRouteByPath(), hasMinimumRouteRole() (+2 more)
...
### Community 162 - "App"
Cohesion: 0.20
Nodes (9): App(), buildFeatureCollection(), buildLegend(), getQuantile(), getRouteByKey(), useRegions(), formatCurrency(), MapPage() (+1 more)
...
### Community 203 - "Table Definitions"
Cohesion: 0.18
Nodes (11): 1. `regions` - Administrative Boundaries, 2. `payments` - Payment Records, 3. `uploads` - File Upload Tracking, 3a. `region_aliases` - Canonical Import Aliases, 4. `report_jobs` - Report Generation Jobs, 5. `audit_logs` - Immutable Request Audit Trail, 6. `revenue_targets` - Monthly Analytics Targets, 7. `approval_workflows` and `approval_workflow_events` (+3 more)
...
Cohesion: 0.06
Nodes (50): mockQuery, mockRedisConnect, mockRedisDel, mockRedisGet, mockRedisKeys, mockRedisOn, mockRedisSetEx, mockRedisGet (+42 more)
...
Cohesion: 0.17
Nodes (25): asNumber(), asObject(), asString(), firstValue(), JsonObject, normalizeFinding(), normalizeReportingDetail(), normalizeSeverity() (+17 more)
...
Cohesion: 0.06
Nodes (83): formatAmount(), formatNumber(), formatPercent(), formatPeriod(), formatUpdatedAt(), hasAnalyticsData(), idrFormatter, normalizeAnalyticsPeriod() (+75 more)
...
### Community 490 - "ScheduledReportJobData"
Cohesion: 0.50
Nodes (3): ReportGenerationLookupQueue, ScheduledReportQueue, ScheduledReportJobData

### Community 491 - "Topbar.tsx"
Cohesion: 0.40
Nodes (3): PeriodSelectProps, Topbar(), TopbarProps

### Community 492 - "middleware/auth.ts"
Cohesion: 0.17
Nodes (18): approvalController, allowRoles, assertUserRole(), AuthPayload, Express, hasMinimumRole(), isRole(), Request (+10 more)

### Community 493 - "lib/auth.ts"
Cohesion: 0.26
Nodes (11): fetchJson(), ACCESS_TOKEN_KEYS, AuthState, decodeJwtPayload(), getAccessToken(), getUserRole(), isAdminUser(), readAuthState() (+3 more)
...
Cohesion: 0.09
Nodes (24): analyticsController, geoController, getChoropleth, getRegionSummary, listRegions, regionController, uploadController, auditMiddleware() (+16 more)
...
### Community 500 - "main.tsx"
Cohesion: 0.60
Nodes (4): bootstrap(), disableMocking(), enableMocking(), queryClient

### Community 501 - "UploadPage.tsx"
Cohesion: 0.31
Nodes (9): useUpload(), useUploadRows(), asNumberOrNull(), findingClasses(), isExcel(), statusLabel(), stepClasses(), UploadPage() (+1 more)
...
### Community 510 - "uploads.ts"
Cohesion: 0.19
Nodes (10): ACCEPTED_MIME_TYPES, memoryUpload, canReadReports, rejectLockedReportPeriod, reportRouter, canManageUploads, rejectLockedUploadPeriod, uploadRouter (+2 more)
...
### Community 512 - "7. Object Storage"
Cohesion: 0.67
Nodes (3): 7. Object Storage, Bucket Structure, Security & Deduplication
...
### Community 521 - "Rollback Plan"
Cohesion: 0.50
Nodes (4): Database Rollback, Full Rollback (Both), Quick Rollback (Frontend), Rollback Plan

### Community 522 - "Post-Migration"
Cohesion: 0.50
...
## Knowledge Gaps
- **2622 isolated node(s):** `mockQuery`, `mockRedisGet`, `mockRedisSetEx`, `mockRedisKeys`, `mockRedisDel` (+2617 more)
...
- **Why does `vitest` connect `redis.ts` to `server.ts`, `report-worker.ts`, `scheduled-report-service.ts`, `compilerOptions`, `upload-pipeline.integration.test.ts`, `middleware/auth.ts`, `upload-validation.ts`, `report-email-service.ts`, `validators/analytics.ts`, `routes.ts`, `Legend.tsx`, `AuditLogInspector.tsx`, `upload-worker.ts`, `AnalyticsPage.tsx`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `getPgPool()` connect `getPgPool` to `server.ts`, `report-worker.ts`, `approval-service.ts`, `scheduled-report-service.ts`, `buildRankingQuery`, `upload-pipeline.integration.test.ts`, `upload-controller.ts`, `src/index.ts`, `redis.ts`, `analytics-service.ts`, `audit-service.ts`, `buildOverview`, `upload-worker.ts`, `alert-service.ts`, `uploads.ts`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `Production Deployment Guide` connect `Production Deployment Guide` to `Environment Setup`, `SSL/TLS Configuration`, `Database Migration`, `Backup & Disaster Recovery`, `Deployment Methods`, `Troubleshooting`, `Security Checklist`, `Rollback Procedures`, `Appendix: Production Checklist`, `Scaling Guidelines`, `Monitoring & Observability`, `Prerequisites`, `Maintenance Windows`, `database-schema.md`?**
