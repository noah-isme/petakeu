...
## Corpus Check
- 569 files · ~526,203 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4783 nodes · 6282 edges · 539 communities (350 shown, 189 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 107 edges (avg confidence: 0.59)
...
### Community 1 - "getPgPool"
Cohesion: 0.07
Nodes (45): getPgPool(), instrumentQuery(), rankings, renderPdf(), rows, addMonths(), applyHeaderStyle(), decodeSafeLogo() (+37 more)
...
### Community 3 - "cn"
Cohesion: 0.09
Nodes (37): AnalyticsSectionProps, MapModeToggle(), MapModeToggleProps, defaultOptions, PeriodSelector(), PeriodSelectorProps, getIcon(), LeftSidebar() (+29 more)
...
Cohesion: 0.11
Nodes (23): enqueueReport, getReportById, listReports, reportController, actorId(), bodyObject(), cancelUpload, confirmUpload (+15 more)
...
Cohesion: 0.13
Nodes (15): AnalyticsQueryParams, AnalyticsAmountBasis, AnalyticsNumber, AnalyticsOutlier, AnalyticsOverview, AnalyticsOverviewMeta, AnalyticsOverviewResponse, AnalyticsProvinceMetric (+7 more)
...
Cohesion: 0.09
Nodes (42): getCached(), invalidateCacheByPrefix(), startMvRefreshCron(), EXPECTED_HEADERS, findingToError(), isFuturePeriod(), normalizeHeader(), parseRows() (+34 more)
...
Cohesion: 0.06
Nodes (65): UploadDetailsResponse, uploadQueue, ACCEPTED_MIME_TYPES, aliasRow(), cancelUpload(), createRegionAlias(), currentRow(), dbPeriod() (+57 more)
...
Cohesion: 0.22
Nodes (20): getRedisClient(), getReportQueue(), getUploadQueue(), checkStorageHealth(), checkDatabase(), checkQueue(), checkRedis(), checkStorage() (+12 more)
...
Cohesion: 0.14
Nodes (31): Role, appendTransition(), ApprovalRow, approvalService, approveWorkflow(), assertPeriodUnlockedWithClient(), assertWorkflowPeriodUnlocked(), fromDatabasePeriod() (+23 more)
...
### Community 105 - "audit-service.ts"
Cohesion: 0.22
...
Cohesion: 0.13
Nodes (33): ensureBucket(), getPresignedDownloadUrl(), getS3Client(), uploadStreamToS3(), uploadToS3(), EnqueueReportResponse, ReportDetailsResponse, EnqueueUploadResponse (+25 more)
...
### Community 193 - "KpiCards.tsx"
Cohesion: 0.43
Nodes (5): formatNumber(), KpiCards(), KpiCardsProps, trendClasses(), AnalyticsKpis
...
### Community 222 - "Phase 2: Backend Core Implementation (Week 2-4)"
Cohesion: 0.33
...
Cohesion: 0.06
Nodes (42): mockQuery, mockRedisConnect, mockRedisDel, mockRedisGet, mockRedisKeys, mockRedisOn, mockRedisSetEx, mockRedisGet (+34 more)

### Community 368 - "Phase 3: Frontend Switchover (Week 4-5)"
Cohesion: 0.40
...
Cohesion: 0.10
Nodes (37): formatAmount(), formatPercent(), formatPeriod(), formatUpdatedAt(), hasAnalyticsData(), idrFormatter, normalizeAnalyticsPeriod(), numberFormatter (+29 more)
...
Cohesion: 0.09
Nodes (27): analyticsController, geoController, getChoropleth, uploadController, isAuthPayload(), requireAuth(), ACCEPTED_MIME_TYPES, memoryUpload (+19 more)
...
### Community 500 - "Appendix: Production Checklist"
Cohesion: 0.50
...
Cohesion: 0.14
Nodes (22): options, setupSwagger(), swaggerSpec, boundedString(), deriveContext(), Express, firstString(), getRequestField() (+14 more)

### Community 512 - "Backup & Disaster Recovery"
Cohesion: 0.67
...
### Community 528 - "Maintenance Windows"
Cohesion: 0.67
Nodes (3): Maintenance Windows, Scheduled Maintenance, Zero-Downtime Deployments

## Knowledge Gaps
- **2656 isolated node(s):** `mockQuery`, `mockRedisGet`, `mockRedisSetEx`, `mockRedisKeys`, `mockRedisDel` (+2651 more)
...
- **Why does `vitest` connect `redis.ts` to `health.ts`, `getPgPool`, `scheduled-report-service.ts`, `routes.ts`, `compilerOptions`, `upload-pipeline.integration.test.ts`, `middleware/auth.ts`, `validators/report.ts`, `report-email-service.ts`, `validators/analytics.ts`, `Legend.tsx`, `client.ts`, `UploadPage.tsx`, `AuditLogInspector.tsx`, `upload-worker.ts`, `AnalyticsPage.tsx`, `upload-service.ts`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `getPgPool()` connect `getPgPool` to `health.ts`, `approval-service.ts`, `scheduled-report-service.ts`, `buildRankingQuery`, `upload-pipeline.integration.test.ts`, `audit-service.ts`, `upload-controller.ts`, `src/index.ts`, `redis.ts`, `upload-service.ts`, `analytics-service.ts`, `buildOverview`, `upload-worker.ts`, `alert-service.ts`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `react` connect `cn` to `web/.eslintrc.json`, `Topbar.tsx`, `CommandPalette.tsx`, `MapDashboard.tsx`, `ReportBuilderPage.tsx`, `lib/auth.ts`, `App.tsx`, `Legend.tsx`, `MapPage.tsx`, `AdminDashboard.tsx`, `AuditLogInspector.tsx`, `main.tsx`, `AnalyticsPage.tsx`, `UploadPage.tsx`, `MainLayout.tsx`?**
...
- **Should `getPgPool` be split into smaller, more focused modules?**
